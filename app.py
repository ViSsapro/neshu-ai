...
# ==========================================
# 🌟 ඔයාගේ ෆොටෝ එක සෙට් කරන專ධාන තැන 🌟
# ==========================================
...
# ⚠️ වැදගත්: පහත තැන්වලට ඔයාගේ ඇත්තම විස්තර ඇතුළත් කරන්න.
...
st.markdown(
    ...
    <div class="custom-footer">
        ...
        📞 <b>Contact:</b> <a href="https://wa.me/{WHATSAPP_NUMBER}" target="_blank">{DISPLAY_NUMBER} (WhatsApp 💬)</a>
    </div>
    """,
    unsafe_allow_html=True
)
